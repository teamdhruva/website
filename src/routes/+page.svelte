...
<div class="flex flex-col min-h-screen">
  <section
    class="flex items-center justify-center background h-screen"
    id="home"
  >
  ...
  <section
    ...
    id="Projects"
  >
    <p class="sectionTag text-big font-bold text-center text-white mb-8">
      PROJECTS
    </p>
    ...
    <div class="grid grid-cols-3 gap-6 max-w-screen-lg">
      ...
      >
        ...
        <button
          class="bg-orange-500 hover:bg-blue-600 text-white py-2 px-4 rounded"
        >
          Learn More
        </button>
      </div>
  ...
  <section class="secRight h-screen" id="About us">
    <div class="paras">
      <p class="sectionTag textbig">ABOUT US</p>
      <div
      ...
      >
        ...
        <p class="text-wrap text-base">
          ...
          universe is now a growing team of amateur astrophysics enthusiasts.
          Like dhruva, the pole star, we at dhruva also constantly try to keep
          up with the happenings of the universe and events affecting earth
          through our telescopes, radio telescopes and analysis.
        </p>
        <p>
          ...
          astrophysics community across the globe. We also believe in sharing
          our understanding with fellow astrophysics enthusiasts through our
        ...
        <p>
          ...
          other student astrophysics clubs for organizing interactive sessions
          and better outreach.
        </p>
        <p>
    ...
    <div class="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="col-span-1 md:col-span-2">
        ...
        <p class="mb-4">
          ...
          <br />BENGALURU - 560059, INDIA.
        </p>
        <p>
          Write to us at:<a href="mailto:contact@teamdhruva.com"
      ...
      <div class="col-span-1">
        ...
        <div class="flex space-x-4">
          <a
            ...
            class="flex items-center justify-center social-link"
          >
            <Instagram />
          </a>
          <a
      ...
      <a href="#" class="social-link"><img src="linkedin-icon.svg" alt="Discord"></a> -->
        ...
        <form class="mt-4">
          ...
          <input
            ...
            class="p-2 bg-neutral-700 border border-gray-300 rounded-l-md focus:outline-none"
          />
          <button
            type="submit"
            class="bg-blue-500 hover:bg-blue-600 text-BLACK px-4 py-2 rounded-r-md"
            >Subscribe</button
          >
        </form>
      </div>
