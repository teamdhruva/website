<div class="flex flex-1 flex-col items-center regular-bg">
  <div class="flex flex-col max-w-screen-lg mx-4 mb-4 mt-40 text-xl gap-4">
    <h1 class="text-4xl text-center font-bold text-white">About</h1>
